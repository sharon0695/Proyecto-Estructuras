...
function LoginPage() {
  ...
  return (
    <div className="login-page min-vh-100 d-flex align-items-center" style={{
          ...
          <div className="col-md-5 col-lg-4">
            <div className="card border-0 shadow-lg p-4" style={{ 
              ...
              <div className="text-center mb-4">
                ...
                <h2 className="fw-bold mb-1" style={{ color: '#004d3d' }}>Iniciar sesión</h2>
                <p className="text-muted small">Accede con tu correo para continuar.</p>
              </div>

              {registered && !success && !error ? (
                <div className="alert alert-success py-2 text-center small mb-3" role="alert">
                  Cuenta creada correctamente. Inicia sesión.
                </div>
              ) : null}

              {success ? <div className="alert alert-success py-2 text-center small mb-3" role="alert">{success}</div> : null}
              ...
              <div className="text-center mt-2">
                <p className="small text-muted mb-0">
                  ¿No tienes cuenta? <Link to="/registro" className="fw-bold text-decoration-none" style={{ color: '#004d3d' }}>Regístrate aquí</Link>
                </p>
              </div>
            </div>
          </div>
